...
namespace Tipper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            optimizer.LowerLimitNeuronsInLayer = 6;
            ...
            testingData = tipper.LearnFromTo(2014, 1, 2014, 24);
            ...
            trainingData = tipper.LearnFromTo(2010, 0, 2015, 3);
            ...
            var tips = tipper.Predict(2015, 4, true);
            /*for (var i = 2; i <= 2; i++)
            {
