...
namespace AustralianRulesFootball
{
    public class Ground
    {
        ...
        public static Ground Es = new Ground("ES", new List<string> {"Etihad Stadium","Colonial Stadium", "Telstra Dome"}, new List<string> {}, State.Victoria, new GeographicCoordinate(-37.8164, 144.9475));
